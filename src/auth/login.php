...
<center>You don't have an account yet ? <button id="signin_bt">Signin</button> or <button id="respwd_bt">Reset password</button></center>
    <form action="./middleware/coblog.php" method="post" >
...
<div id="resmdp">
    ...
    <center>Cancel ? <a href="./index.php" style="text-decoration:none; " id="login_bt">Back</a></center>
    <form action="./middleware/coblog.php" style="margin-top:20px; " method="post" >
        <label >Username</label>
        <input type="text" name="username" required>
